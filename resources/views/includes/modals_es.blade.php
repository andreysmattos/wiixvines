  ...
  <div class="modal-dialog modal-dialog-centered " role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h5 class="modal-title font-weight-bold text-center" id="exampleModalLabel">Welcome to Tibia Vines! 😜 </h5>
      ...
      <div class="modal-body">
        ...
        <small class="text-muted">to like, comments or subscribes.</small>
      </div>
      </div>
...
If you do not agree or do not want to follow any of these rules, please do not continue the operation.
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-vines">Create Channel</button>
      </div>
    </form>
    </div>
  </div>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        What you think start put your <a href="/user/upload-photo">first photo</a> in Tibia Vines? ;-)
    </div>
  </div>
</div>
</div>
