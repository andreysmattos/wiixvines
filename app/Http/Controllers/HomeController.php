...
class HomeController extends Controller
{
    ...
    {   
        ...
        return view('painel.index', ['allviews' => $allviews, 'mostview' => $mostview, 'subs' => $subs, 'countvines' => $countvines, 'cname' => $cname, 'cdesc' => $cdesc, 'ditem' => $ditem], $data)->with($not)->with($locale);
